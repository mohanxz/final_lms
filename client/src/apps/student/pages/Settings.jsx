  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-cyan-50/30 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="relative z-10 max-w-5xl mx-auto p-6 lg:p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-600 bg-clip-text text-transparent">
            Profile & Settings
          </h1>
            ...
            <div className="p-6 lg:p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">Update your personal details and social links</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <FaUser className="inline mr-2 text-blue-500 dark:text-cyan-400 text-xs" />
                    Full Name
                  </label>
                  <input
                    disabled
                    name="name"
                    value={form.name}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 cursor-not-allowed"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <MdOutlineEmail className="inline mr-2 text-blue-500 dark:text-cyan-400 text-sm" />
                    Email Address
                  </label>
                  <input
                    disabled
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <FaPhone className="inline mr-2 text-blue-500 dark:text-cyan-400 text-xs" />
                    Phone Number
                  </label>
                  <input
                    name="phone"
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <FaBirthdayCake className="inline mr-2 text-blue-500 dark:text-cyan-400 text-xs" />
                    Date of Birth
                  </label>
                  <input
                    type="date"
                    ...
                    value={form.dob}
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
                </div>
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <FaMapMarkerAlt className="inline mr-2 text-blue-500 dark:text-cyan-400 text-xs" />
                    Address
                  </label>
                  <input
                    name="address"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <FaGithub className="inline mr-2 text-blue-500 dark:text-cyan-400 text-sm" />
                    GitHub Profile
                  </label>
                  <input
                    name="github"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">
                    <FaLinkedin className="inline mr-2 text-blue-500 dark:text-cyan-400 text-sm" />
                    LinkedIn Profile
                  </label>
                  <input
                    name="linkedin"
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="space-y-5 max-w-2xl">
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-12 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <MdOutlinePassword className="text-gray-400 group-focus-within:text-blue-500 transition-colors" />
                    </div>
                    <input
                ...
                {/* Security Tips */}
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-cyan-800">
                  <div className="flex items-start gap-3">
                    <FaShieldAlt className="text-blue-500 dark:text-cyan-400 text-lg mt-0.5" />
                    <div>
                ...
                <button
                  ...
                  className="w-full md:w-auto px-8 py-3 bg-gradient-to-r from-gray-800 to-gray-900 hover:from-gray-900 hover:to-black text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] flex items-center justify-center gap-2"
                >
                  <FaLock />
                  Update Password
                </button>
